...
6. 参考まで、`wpa_cli` で WPS(Wi-Fi Protected Setup) をつかった設定も可能で、起動時のジャンパ線の設定によって自動的に WPS で設定させる実装例も[報告されている](http://qiita.com/UedaTakeyuki/items/e63f4c06ab2814f4fb27)のだが、  
そもそも WPS 自体があまり存在を知られておらず、次に説明する `addwpa` のほうが使ってもらいやすい。
...
5. addwpa は[github](https://github.com/UedaTakeyuki/addwpa)で公開してメンテされている  
