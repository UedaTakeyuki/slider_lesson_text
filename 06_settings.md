...
`1 Expand Filesystem` は、サイズの大きい SD カードにコピーした際に余った領域の端まで ext4 のパーティションを拡張してくれる。SD カード間の互換性を確保するために後ろの未使用領域を余らせていたほうが良いので、これを使うことはほぼない
...
<img src="pic/ss.2017-03-23 21.50.30.png" width="54%">

<img src="pic/ss.2017-03-23 21.50.35.png" width="54%">

<img src="pic/ss.2017-03-23 21.50.41.png" width="54%">

<img src="pic/ss.2017-03-23 21.50.48.png" width="54%">
